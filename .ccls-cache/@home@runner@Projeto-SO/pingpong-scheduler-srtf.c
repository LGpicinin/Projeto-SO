...
// 600, 700, 800, 900, 1000}; // cenario 1 int
// user_tasks_execution_time[USER_TASKS_MAX] = {1000, 900, 800, 700, 600, 500,
// 400, 300, 200, 100}; // cenario 2
int user_tasks_execution_time[USER_TASKS_MAX] = {
    30, 50, 70, 90, 110, 130, 150, 170, 190, 210}; // cenario 3
// int user_tasks_execution_time[USER_TASKS_MAX] = {210, 190, 170, 150, 130,
// 110, 90, 70, 50, 30}; // cenario 4
...
void Body(void *arg) {
  ...
  // o campo taskExec->running_time indica o tempo que a tarefa executou ate o
  // momento se for o caso, esse campo pode ser trocado conforme a implementacao
  // de cada equipe o que importa eh esse loop sair somente se a tarefa
